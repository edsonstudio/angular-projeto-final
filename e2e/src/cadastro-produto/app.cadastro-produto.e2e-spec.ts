...
describe('Testes do formulario de cadastro', () => {
  ...
  it('deve navegar até produtos', async () => {
    page.iniciarNavegacao();
    expect(await page.obterTituloProdutos()).toEqual('Lista de Produtos');
  });

  it('deve preencher formulário de produtos com sucesso', async () => {
